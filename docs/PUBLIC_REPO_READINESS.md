...
- [x] README includes setup, environment variable names, architecture boundary, tests and known limitations.
- [x] Fictional data only; no customer or personal data.
- [x] Secret, private-key and forbidden cross-project scans pass.
- [x] Live evidence excludes prompts, model output, AWS identity and credentials.
- [x] Public DEMO disables the paid Live endpoint by default.
- [x] Devpost and five-minute video drafts updated with the real evidence boundary.
...
The final three items are intentionally not performed by the Writer or reviewers.
